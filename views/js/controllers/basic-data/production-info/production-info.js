app.controller('productionInfoController', productionInfoController);
productionInfoController.$inject = ['$scope', 'Restangular' ,'ngTableParams', 'dialogs', 'toaster', '$http', '$rootScope', '$filter'];
function productionInfoController($scope, Restangular, NgTableParams, dialogs, toaster, $http, $rootScope, $filter) {
	$scope.resoures = {
		list: [],//信息列表
	};
	...
	//临时数据
	$scope.prodTestData = [
		{platNo:'1', prodName:"YFL-1-T/B", stdWeight:"50", mouWeight:"14", countPerMould:"3", numPerDay:"413",prodCycPerSec:"209",capacityPerDay:"209",countPerHour:"1240",capacityPerHour:"48", changeFlg:"true"},
	];
	//临时赋予数据
	...
	function add(item) {
		var dlg = dialogs.create('views/tpl/basic-data/production-info/add.html','addProductionInfoController',{data:item},{size:'md'});
    };
	
    function modify(item) {
		var dlg = dialogs.create('views/tpl/basic-data/production-info/modify.html','modifyProductionInfoController',{data:item},{size:'md'});	
    };

    function deleted(item) {
		var dlg = dialogs.create('views/tpl/basic-data/production-info/delete.html','deteleProductionInfoController',{data:item},{size:'sm'});	
	};
	$scope.data = {
		search:'',
	};
...
app.controller('addProductionInfoController',function($scope, $modalInstance, Restangular, data, toaster, $rootScope){
	$scope.title = "新增生产基础数据";
	//临时测试数据
	// $scope.prodUuid = [
...
app.controller('modifyProductionInfoController',function($scope, $modalInstance, data, Restangular, $rootScope, toaster){
	$scope.title = "生产基础变更";
	//选中的行赋给details数组
...
app.controller('deteleProductionInfoController',function($scope, $modalInstance, data, Restangular, $rootScope,toaster){
	console.log(data);
