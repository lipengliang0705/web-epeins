...
function taskInfoController($scope, Restangular, NgTableParams, dialogs, toaster, $http, $rootScope, $filter) {
	...
	//临时数据
	$scope.prodTestData = [
		{platNo:'1', prodId:"P01", taskId:"ZJG-20190722F2-119", taskCount:"1000", materialColor:"黑色", memo:"任务单信息", changeFlg:"true"},
		{platNo:'2', prodId:"P02", taskId:"ZJG-20190722F2-119", taskCount:"800", materialColor:"黑色", memo:"任务单信息", changeFlg:"true"},
		{platNo:'3', prodId:"P03", taskId:"ZJG-20190722F2-119", taskCount:"850", materialColor:"黑色", memo:"任务单信息", changeFlg:"false"},
	];
	//临时赋予数据
