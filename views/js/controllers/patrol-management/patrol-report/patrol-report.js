app.controller('salesPlanController', salesPlanController);
salesPlanController.$inject = ['$scope', 'Restangular' ,'ngTableParams', 'dialogs', 'toaster', '$http', '$rootScope', '$filter'];
function salesPlanController($scope, Restangular, NgTableParams, dialogs, toaster, $http, $rootScope, $filter) {
	$scope.resoures = {
		list: [],//信息列表
	};
	$scope.machineType = {
	...
	function add(item) {
		var dlg = dialogs.create('views/tpl/warehouse-management/sales-plan/add.html','addPurchasePlanController',{data:item},{size:'md'});
    };
	
    function modify(item) {
		var dlg = dialogs.create('views/tpl/warehouse-management/sales-plan/modify.html','modifyPurchasePlanController',{data:item},{size:'md'});	
    };

    function deleted(item) {
		var dlg = dialogs.create('views/tpl/warehouse-management/sales-plan/delete.html','detelePurchasePlanController',{data:item},{size:'sm'});	
	};
	$scope.data = {
		search:'',
	};
