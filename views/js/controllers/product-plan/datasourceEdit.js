app.controller('dataSourceController', ['$scope', 'Restangular' ,'ngTableParams', 'dialogs', 'toaster', 
    ...
    var create = function () {
		var dlg = dialogs.create('views/tpl/layer/logsmanage/datasourceEdit.html','EditDataSourceController',{},{size:'md'});
		/*
    ...
    var deleted = function () {
		var dlg = dialogs.create('views/tpl/layer/logsmanage/delete.html','deteleDataController',{},{size:'md'});
