app.controller('modelBasedataController', ['$scope', 'Restangular' ,'ngTableParams', 'dialogs', 'toaster', 
	function($scope, Restangular, NgTableParams, dialogs, toaster) {

 var testData = [
 	{code:'1', machine:"1#",model:'XJ-20-B', moldingWeight:"14",outputs:'3', modulus:"413",productionCycle:'209', capacity:"1240", actual:"52", hourlyCapacity:"48"},
 	{code:'1', machine:"2#",model:'TM-3-T', moldingWeight:"13",outputs:'4', modulus:"403",productionCycle:'200', capacity:"1240", actual:"50", hourlyCapacity:"45"},
 ...
 $scope.toggleDropdown = function($event) {
  ...
  $scope.status.isopen = !$scope.status.isopen;
	...
	var add = function (item) {
		var dlg = dialogs.create('views/tpl/layer/model-basedata/add.html','addController',{},{size:'md'});
    };
	
    function modify(item) {
    	console.log(item);
		var dlg = dialogs.create('views/tpl/layer/model-basedata/modify.html','modifyController',{data:item},{size:'md'});
    ...
    var deleted = function () {
		var dlg = dialogs.create('views/tpl/layer/model-basedata/delete.html','deteleDataController',{},{size:'sm'});
